...
const Layout = ({navbarSx, title ,children ,desc } : ILayout) => {
  ...
  return (
    ...
    <>
    <Head >
        <title>{title || "Mutiso Peter Personal Portfolio | Kenya Web Developer"}</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <link rel="shortcut icon" href="https://res.cloudinary.com/dr4ssexud/image/upload/v1747987472/default_hjvzpb.png" />
...
<meta property="og:image" content="https://res.cloudinary.com/dr4ssexud/image/upload/v1747987472/default_hjvzpb.png"/>
...
<meta property="og:type" content="article" /> */}
   ...
   <meta httpEquiv="content-language" content="en"/>
    ...
    <meta name="author" content="Mutiso Juma" />
